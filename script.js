...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  async function gerarComprovantePagamento(
    ...
    img.onload = function() {
      ...
      canvas.width = img.naturalWidth; // Ou defina como 160 se você quiser redimensionar
      canvas.height = img.naturalHeight; // Ou defina como 160 se você quiser redimensionar
